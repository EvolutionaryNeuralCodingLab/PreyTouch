...
class CacheColumns:
    ...
    LAST_AGENT_ERROR = Column('LAST_AGENT_ERROR', str, 'static')
    ...
    DAILY_SUCCESS_ANNOUNCED_DATE = Column('DAILY_SUCCESS_ANNOUNCED_DATE', str, 'static')
    DAILY_BUG_HIT_ANNOUNCED_DATE = Column('DAILY_BUG_HIT_ANNOUNCED_DATE', str, 'static')
    ...
    DAILY_TIMELAPSE_SENT_CAMERAS = Column('DAILY_TIMELAPSE_SENT_CAMERAS', list, 'static')
    DAILY_TIMELAPSE_SUMMARY_SENT_CAMERAS = Column('DAILY_TIMELAPSE_SUMMARY_SENT_CAMERAS', list, 'static')
    DAILY_SUMMARY_ATTEMPTS = Column('DAILY_SUMMARY_ATTEMPTS', list, 'static')
    DAILY_TIMELAPSE_ATTEMPTS = Column('DAILY_TIMELAPSE_ATTEMPTS', list, 'static')
    DAILY_TIMELAPSE_SUMMARY_ATTEMPTS = Column('DAILY_TIMELAPSE_SUMMARY_ATTEMPTS', list, 'static')
    TIMELAPSE_CAPTURE_HEARTBEAT = Column('TIMELAPSE_CAPTURE_HEARTBEAT', float, 'static')
