...
const blockFields = {
  ...
  bugs: {
    ...
    tunnel_image: new FieldObject('tunnelImage', Field, {movement_type: [ 'pt_tunnel']}),
    tunnel_rotation: new FieldObject('tunnelRotation', NumericalField, {movement_type: ['pt_tunnel']}),
    tunnel_scale: new FieldObject('tunnelScale', NumericalField, {movement_type: ['pt_tunnel']}),
    tunnel_opacity: new FieldObject('tunnelOpacity', NumericalField, {movement_type: ['pt_tunnel']}),
