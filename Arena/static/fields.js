...
const blockFields = {
  ...
  bugs: {
    ...
    tunnel__image: new FieldObject('tunnelimage', Field, {movement_type: 'rect_tunnel'}),
    tunnel__rotation: new FieldObject('tunnelRotation', NumericalField, {movement_type: 'rect_tunnel'}),
    tunnel__scale: new FieldObject('tunnelScale', NumericalField, {movement_type: 'rect_tunnel'}),
    tunnel__opacity: new FieldObject('tunnelOpacity', NumericalField, {movement_type: 'rect_tunnel'}),
