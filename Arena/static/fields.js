...
const blockFields = {
  ...
  bugs: {
    ...
    is_split_bugs_view: new FieldObject('isSplitBugsView', CheckField, {movement_type: 'circle', num_of_bugs: 2}),
    split_repeated_pos_ratio: new FieldObject('splitRepeatedPosRatio', NumericalField),
    ...
    tunnel_food_image: new FieldObject('tunnelFoodImage', Field, {movement_type: 'rect_tunnel'}),
    tunnel_food_rotation: new FieldObject('tunnelFoodRotation', NumericalField, {movement_type: 'rect_tunnel'}),
    tunnel_food_scale: new FieldObject('tunnelFoodScale', NumericalField, {movement_type: 'rect_tunnel'}),
    tunnel_food_opacity: new FieldObject('tunnelFoodOpacity', NumericalField, {movement_type: 'rect_tunnel'}),
